...
const query = '{ jurisdictions { code name fullName } forms { _id title groupName fields { label type isMulti items isString isDate isNumber isPerson isJurisdiction isChoice } } }';
